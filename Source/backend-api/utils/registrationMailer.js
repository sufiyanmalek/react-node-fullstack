...
export async function NodeMailer(userEmail, Data) {
  ...
  let info = await transporter.sendMail({
    ...
    subject: "User Registration Successfull", // Subject line
    text: ``, // plain text body
    html: `Hello User, You are successfully registered to our Organitation. <br>Your Credentials: <br> 
